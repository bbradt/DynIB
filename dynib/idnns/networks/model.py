...
import numpy as np
from dynib.idnns.networks.utils import _convert_string_dtype
from dynib.idnns.networks.models import multi_layer_perceptron
from dynib.idnns.networks.models import deepnn
...
class Model:
    ...
    def __init__(self, input_size, layerSize, num_of_classes, learning_rate_local=0.001, save_file='',
                 activation_function=0, cov_net=False, from_layer=0):
        self.covnet = cov_net
